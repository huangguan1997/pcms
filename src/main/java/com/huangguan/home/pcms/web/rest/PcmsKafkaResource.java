...
@RestController
@RequestMapping("/api/pcms-kafka")
public class PcmsKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PcmsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PcmsKafkaResource(KafkaProperties kafkaProperties) {
